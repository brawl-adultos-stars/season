		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Brawl Stars - Season",
									"targetURL": "#brawladultosseason-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brawladultosseason-display": {
								"semanticObject": "brawladultosseason",
								"action": "display",
								"description": "Season Tracker",
								"title": "Brawl Stars - Season",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=brawl.adultos.season",
									"url": sap.ui.require.toUrl("brawl/adultos/season")
								}
							}
						}
					}
